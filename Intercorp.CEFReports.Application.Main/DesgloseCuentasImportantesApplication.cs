...
{
    public class DesgloseCuentasImportantesApplication : IDesgloseCuentasImportantesApplication
    {
        private readonly ICuentaAnalisisDomain _cuentaAnalisisDomain;
        private readonly IMapper _mapper;
        public DesgloseCuentasImportantesApplication(ICuentaAnalisisDomain cuentaAnalisisDomain, IMapper mapper)
        {
            _cuentaAnalisisDomain = cuentaAnalisisDomain;
            _mapper = mapper;
        }
        public async Task<Response<CuentaAnalisisDTO>> ObtenerDesgloseCuentasImportantes(CuentaAnalisisRequestDTO requestDTO)
        {
        ...
        public async Task<Response<String>> ObtenerDesgloseCuentasImportantesPDF(CuentaAnalisisRequestDTO requestDTO)
        {
            ...
            try
            {
                ...
                if (result != null)
                {
                    var archivo = new SlipPDFHelper().GenerarSLIP(result, "DesgloseCuentasImportantes");
