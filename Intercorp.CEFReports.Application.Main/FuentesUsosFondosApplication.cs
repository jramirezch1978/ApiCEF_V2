...
{
    public class FuentesUsosFondosApplication : IFuentesUsosFondosApplication
    {
        private readonly ICuentaAnalisisDomain _cuentaAnalisisDomain;
        private readonly IMapper _mapper;
        public FuentesUsosFondosApplication(ICuentaAnalisisDomain cuentaAnalisisDomain, IMapper mapper)
        {
            _cuentaAnalisisDomain = cuentaAnalisisDomain;
            _mapper = mapper;
        }
        public async Task<Response<CuentaAnalisisDTO>> ObtenerFuentesUsosFondos(CuentaAnalisisRequestDTO requestDTO)
        {
        ...
        public async Task<Response<String>> ObtenerFuentesUsosFondosPDF(CuentaAnalisisRequestDTO requestDTO)
        {
            ...
            try
            {
                ...
                if (result != null)
                {
                    var archivo = new SlipPDFHelper().GenerarSLIP(result, "FuentesUsosFondos");
