...
{
    public class EstadoGananciaPerdidaApplication : IEstadoGananciaPerdidaApplication
    {
        private readonly ICuentaAnalisisDomain _cuentaAnalisisDomain;
        private readonly IMapper _mapper;
        public EstadoGananciaPerdidaApplication(ICuentaAnalisisDomain cuentaAnalisisDomain, IMapper mapper)
        {
            _cuentaAnalisisDomain = cuentaAnalisisDomain;
            _mapper = mapper;
        }
        public async Task<Response<CuentaAnalisisDTO>> ObtenerEstadoGananciaPerdida(CuentaAnalisisRequestDTO requestDTO)
        {
        ...
        public async Task<Response<String>> ObtenerEstadoGananciaPerdidaPDF(CuentaAnalisisRequestDTO requestDTO)
        {
            ...
            try
            {
                ...
                if (result != null)
                {
                    var archivo = new SlipPDFHelper().GenerarSLIP(result, "EstadoGananciaPerdida");
