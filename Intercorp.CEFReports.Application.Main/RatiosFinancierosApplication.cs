...
{
    public class RatiosFinancierosApplication : IRatiosFinancierosApplication
    {
        private readonly ICuentaAnalisisDomain _cuentaAnalisisDomain;
        private readonly IMapper _mapper;
        public RatiosFinancierosApplication(ICuentaAnalisisDomain cuentaAnalisisDomain, IMapper mapper)
        {
            _cuentaAnalisisDomain = cuentaAnalisisDomain;
            _mapper = mapper;
        }
        public async Task<Response<CuentaAnalisisDTO>> ObtenerRatiosFinancieros(CuentaAnalisisRequestDTO requestDTO)
        {
        ...
        public async Task<Response<String>> ObtenerRatiosFinancierosPDF(CuentaAnalisisRequestDTO requestDTO)
        {
            ...
            try
            {
                ...
                if (result != null)
                {
                    var archivo = new SlipPDFHelper().GenerarSLIP(result, "RatiosFinancieros");
