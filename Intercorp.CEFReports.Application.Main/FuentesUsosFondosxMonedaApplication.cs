...
{
    public class FuentesUsosFondosxMonedaApplication : IFuentesUsosFondosxMonedaApplication
    {
        private readonly ICuentaAnalisisDomain _cuentaAnalisisDomain;
        private readonly IMapper _mapper;
        public FuentesUsosFondosxMonedaApplication(ICuentaAnalisisDomain cuentaAnalisisDomain, IMapper mapper)
        {
            _cuentaAnalisisDomain = cuentaAnalisisDomain;
            _mapper = mapper;
        }
        public async Task<Response<CuentaAnalisisDTO>> ObtenerFuentesUsosFondosxMoneda(CuentaAnalisisRequestDTO requestDTO)
        {
        ...
        public async Task<Response<String>> ObtenerFuentesUsosFondosxMonedaPDF(CuentaAnalisisRequestDTO requestDTO)
        {
            ...
            try
            {
                ...
                if (result != null)
                {
                    var archivo = new SlipPDFHelper().GenerarSLIP(result, "FuentesUsosFondosxMoneda");
